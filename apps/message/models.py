...
class BookMessageTheme(BaseModel):
    ...
    user = models.ForeignKey(Account, verbose_name='发起人', related_name='book_message', on_delete=models.CASCADE)
...
class Comment(BaseModel):  # 定义评论模型
    message = models.ForeignKey(to=BookMessageTheme, on_delete=models.CASCADE, verbose_name='评论文章',related_name='all_comments')
    comment_content = models.TextField(verbose_name='评论内容')
    is_active = models.BooleanField(default=True)
    comment_user = models.ForeignKey(to=Account, on_delete=models.CASCADE, verbose_name='评论者',related_name='user_comments')
...
class MpttComment(MPTTModel):  # 定义评论模型
    ...
    comment_content = models.TextField(verbose_name='评论内容')
    is_active = models.BooleanField(default=True)
    comment_user = models.ForeignKey(to=Account, on_delete=models.CASCADE, verbose_name='评论者',related_name='user_mptt_comments')
